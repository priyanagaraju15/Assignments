...
public class ThreeDArrayAssignment {
	...
	public static void main(String[] args) {
		...
		System.out.println(student[1][0][3]);  // Basic Electronics
		System.out.println(student[1][0][4]);  // Engineering Physics
		
		System.out.println(student[3][1][2]);  // Fail(19)
		System.out.println(student[3][1][5]);  // Pass(87)
	}
